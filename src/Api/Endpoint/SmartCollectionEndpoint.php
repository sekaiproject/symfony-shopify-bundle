...
class SmartCollectionEndpoint extends AbstractEndpoint
{
     ...
     */
    public function findOne($smartCollectionId, array $fields = [])
    {
        $params = $fields ? ['params' => implode(',', $fields)] : [];
    ...
    {
        $request = new PostJson('/admin/smart_collections.json', ['smart_collection' => $smartCollection->toArray()]);
        $response = $this->send($request);
    ...
    {
        $request = new PutJson('/admin/smart_collections/'.$smartCollectionId.'.json', ['smart_collection' => $smartCollection->toArray()]);
        $response = $this->send($request);
     ...
     */
    public function setOrder($smartCollectionId, $sort_order = null, array $productIds = [])
    {
        $params = [];
