...
class ProductImageEndpoint extends AbstractEndpoint
{
     ...
     */
    public function findByProduct($productId, array $query = [])
    {
     ...
     * @return int
     */
    public function countByProduct($productId, array $query = [])
    {
     ...
     */
    public function findOne($productId, $productImageId, array $fields = [])
    {
    ...
    {
        $request = new PostJson('/admin/products/'.$productId.'/images.json', ['image' => $productImage->toArray()]);
        $response = $this->send($request);
    ...
    {
        $request = new PutJson('/admin/products/'.$productId.'/images/'.$productImageId.'.json', ['image' => $productImage->toArray()]);
        $response = $this->send($request);
