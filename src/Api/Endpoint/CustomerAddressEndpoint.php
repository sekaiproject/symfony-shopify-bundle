...
class CustomerAddressEndpoint extends AbstractEndpoint
{
    ...
    {
        $request = new PostJson('/admin/customers/'.$customerId.'/addresses.json', ['address' => $address->toArray()]);
        $response = $this->send($request);
    ...
    {
        $request = new PutJson('/admin/customers/'.$customerId.'/addresses/'.$addressId.'.json', ['address' => $address->toArray()]);
        $response = $this->send($request);
