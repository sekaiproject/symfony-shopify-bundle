...
class CustomCollectionEndpoint extends AbstractEndpoint
{
    ...
    {
        $request = new PostJson('/admin/custom_collections.json', ['custom_collection' => $customCollection->toArray()]);
        $response = $this->send($request);
    ...
    {
        $request = new PutJson('/admin/custom_collections/'.$customCollectionId.'.json', ['custom_collection' => $customCollection->toArray()]);
        $response = $this->send($request);
