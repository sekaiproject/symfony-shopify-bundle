...
class CustomerSavedSearchEndpoint extends AbstractEndpoint
{
     ...
     */
    public function findOne($savedSearchId, array $fields = [])
    {
     ...
     */
    public function findCustomersForSavedSearch($savedSearchId, array $query = [])
    {
    ...
    {
        $request = new PostJson('/admin/customer_saved_searches.json', ['customer_saved_search' => $savedSearch->toArray()]);
        $response = $this->send($request);
    ...
    {
        $request = new PutJson('/admin/customer_saved_searches/'.$savedSearchId.'.json', ['customer_saved_search' => $savedSearch->toArray()]);
        $response = $this->send($request);
